...
class ArtistDetailFragmentTest : AccessibilityTestBase() {

    @get:Rule
    val activityRule = ActivityScenarioRule(MainActivity::class.java)

    @Test
    fun shouldNavigateFromArtistsListToArtistDetail() {
    ...
    @Test
    fun artistDetailShouldDisplayNameAndDescription() {
        onView(withText(R.string.home_card_artists)).perform(click())
    ...
    @Test
    fun artistDetailShouldDisplayAlbumsList() {
        onView(withText(R.string.home_card_artists)).perform(click())
